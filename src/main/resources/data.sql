insert into book values(1, 'opis', 'The Tartar Steppe');
insert into book values(2, 'opis', 'Poem Strip');
insert into book values(3, 'opis', 'Restless Nights: Selected Stories of Dino Buzzati');
